...
Screenshot of an explicitly defined step in the trace inspector
...
To deploy flows with Cloud Functions for Firebase, use the firebase plugin. In your flow definitions, replace defineFlow with onFlow and include an authPolicy.
